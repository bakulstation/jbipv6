...
while [ true ]
do
ret=$(sudo /boot/firmware/PPPwn/$CPPBIN --interface "$INTERFACE" --fw "${FIRMWAREVERSION//.}" --ipv "fe80::4141:4141:4141:4141" --wait-after-pin 1 --groom-delay 4 --buffer-size 2048 --no-wait-padi --timeout 5 --auto-retry)
if [ $ret -ge 1 ] ; then
